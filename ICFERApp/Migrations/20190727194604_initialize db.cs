    ...
    public partial class initializedb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    StudentRegNo = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Education", x => new { x.Id, x.StudentId });
                    table.UniqueConstraint("AK_Education_Id", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Guardian", x => new { x.Id, x.StudentId });
                    table.UniqueConstraint("AK_Guardian_Id", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfDemiseOfFather = table.Column<DateTime>(nullable: false),
                    DateOfDemiseOfMother = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parents", x => new { x.Id, x.StudentId });
                    table.UniqueConstraint("AK_Parents_Id", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Siblings", x => new { x.Id, x.StudentId });
                    table.UniqueConstraint("AK_Siblings_Id", x => x.Id);
                    table.ForeignKey(
